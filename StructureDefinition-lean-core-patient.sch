...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://lean.sa/fhir/lean/core/StructureDefinition/lean-patient-gender-extension']) &lt;= 1">extension with URL = 'http://lean.sa/fhir/lean/core/StructureDefinition/lean-patient-gender-extension': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:name">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://lean.sa/fhir/lean/core/StructureDefinition/lean-human-language-extension']) &lt;= 1">extension with URL = 'http://lean.sa/fhir/lean/core/StructureDefinition/lean-human-language-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
